...
public class MainFrame extends JFrame {
	...
	private List<Symbol> lst = new ArrayList<Symbol>();
	...
	public MainFrame() {
		...
		btnAnalisar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				for(Symbol token : lst) {
					model.addRow(new Object[]{token.value, Sym.terminalNames[token.sym],token.left,token.right});
				}
			}
